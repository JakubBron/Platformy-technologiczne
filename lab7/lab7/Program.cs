...
namespace Lab7
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            FileInfo oldest = Extensions.FindOldestInDirectory(dir);
            Console.WriteLine($"Oldest file: {oldest.Name} @ {oldest.CreationTimeUtc} UTC");
        ...
        private static void printDirectioriesFromLocation(DirectoryInfo dir, string tabulators)
        {
            ...
            Console.WriteLine($"{tabulators}{dir.Name}/ with {files.Length} files & {subdirs.Length} subdir(s): ");
            ...
            {
                Console.WriteLine($"{tabulators+"  "}{file.Name}\t{file.Length} bajtow \t {file.GetAttributes()}");
